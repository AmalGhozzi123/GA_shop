$(document).ready(function () {
	...
	*/
	...
	$("#search_form").submit(function (e) {
		...
		$("#search_btn").click(); // Déclenche le clic sur le bouton de recherche
	});
	...
	*/
	...
	function submitLoginForm() {
		...
		// Effectue une requête AJAX pour vérifier les informations de connexion
		$.ajax({
			url: "login.php", // L'URL du script de traitement de la connexion
			method: "POST",
			data: {
				email: email,
				password: password
			...
			success: function (response) {
				// Redirige vers la page "profile.php" en cas de succès de la connexion
			...
			error: function (xhr, status, error) {
				...
				$("#signup_msg").html("Une erreur s'est produite lors de la connexion. Veuillez réessayer.");
			}
		});
	...
	*/
	function net_total() {
		...
		$('.net_total').html("Total : " + CURRENCY + " DT" + net_total);
	}
	function submitOrderForm() {
		// Récupérer la valeur de choix de livraison
		var deliveryOption = $('input[name=delivery_option]:checked').val();

		// Effectuer une requête AJAX pour valider la commande
		$.ajax({
			url: "validate_order.php", // L'URL du script de traitement de la commande
			method: "POST",
			data: {
				delivery_option: deliveryOption
			},
			success: function (response) {
				// Rediriger vers la page de confirmation de commande en cas de succès
